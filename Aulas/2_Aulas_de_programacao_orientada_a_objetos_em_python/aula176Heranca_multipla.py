...
# Herança múltipla e mixins(classe que não faz parte da herança múltipla)
# Log -> FileLog
# Animal -> Mamifero -> Humano -> Pessoa -> Cliente
...
# D(B, C) - C(A) - B(A) - A
#
# Se um método "qualquer" tiver em A, B e C, como D vai fazer?
#           A
#         /   \
#        B     C
#         \   /
...
class D(B, C): #se o método em D não existir, ele vai em B, se em B n existir, vai em C
    ...

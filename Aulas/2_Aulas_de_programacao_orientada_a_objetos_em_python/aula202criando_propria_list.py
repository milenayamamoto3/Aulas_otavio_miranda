...
# iterable tem o inter, interator tem o inter e o next
# sequence tem o getitem, setitem e len
...
class MyList(Sequence):
    ...
    def __iter__(self):
        return self  #a prórpia lista é o interator para esta aula, pois
    #geralmente seria outra class (MyListIterator)

...
from abc import ABC, abstractmethod #uma forma de abrir class abstrata é importando 'ABC'
                    #outra forma é importando 'ABCMeta', para Log(metaclass=ABCMeta)
class Log(ABC):
    @abstractmethod
    def _log(self, msg): ...
...
#l = Log() # dará erro, pois a class Log não pode ser chamado diretamente
#caso tenha herança de 'ABC' e pelo menos um método abstrato sendo 100% abstrata,

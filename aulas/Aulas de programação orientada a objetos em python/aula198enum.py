...
# Direcoes = enum.Enum('Direcoes', ['DIREITA', 'ESQUERDA'])
class Direcoes(enum.Enum):
    ESQUERDA = 1 #quando a variável é uppercase é uma CONSTANTE(não pode mudar seu valor)
    DIREITA = enum.auto(3) #enumerar o valor
    ACIMA = enum.auto() #enumera automaticamente o valor após o valor anterior "3"
    ABAIXO = enum.auto()

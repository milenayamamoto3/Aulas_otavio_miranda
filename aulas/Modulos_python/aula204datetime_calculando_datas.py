...
# print(delta.days, delta.seconds, delta.microseconds) #delta.seconds é relacionado as hrs
# print(delta.total_seconds()) #total de segundos
# print(data_fim > data_inicio) #bool
# print(data_fim < data_inicio) #bool
# print(data_fim == data_inicio) #bool
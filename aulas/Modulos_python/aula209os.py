...
os.system('cls') #comando para o os limpar o terminal
os.system('echo "Hello world"') #comando para o os imprimir a str em aspas
os.system('dir "C:\\Users\\acerc\\OneDrive\\Área de Trabalho"') #lista os dir e files

...
mimetype_arquivo = mimetypes.guess_type(nome_arquivo)[0]  # tupla
print(mimetype_arquivo)  # [0] take the 'type of picture' only

# na foto ([foto1, foto2,...], open([file's path], bytes), [type of file])
